...
#### Path Name ####
path <- here::here("Final_Project", "results", "remrand5_noobs")
res <- c('Final_Project/results/remrand5_noobs') #subset of path for plot save
...
file_name = paste(path, 'rrand5_noobs_gamma0est.csv',sep = '/')
...
file_name = paste(path, 'rrand5_noobs_gamma1est.csv',sep = '/')
...
file_name = paste(path, 'rrand5_noobs_epsest.csv',sep = '/')
